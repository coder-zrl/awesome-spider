...
class WJXHelper:
    def __init__(self, url, config_path, min_suspend_time=2, max_suspend_time=5, min_completion_time=50,
    ...
    def submit_answer(self):
        ...
        # submit_button.click()
        submit = self.driver.find_element(By.XPATH, "//*[@id='ctlNext']")
        submit.click()
        # 延时 太快会被检测是脚本
        time.sleep(3)
        ...
        # 二次校验，网页是否还有点击提交的按钮，没获取到的话表示问卷提交成功
        try:
            self.driver.find_element(By.XPATH, "//*[@id='ctlNext']")
        except Exception as e:
            return True
        print("触发不可处理的验证")
        return False
